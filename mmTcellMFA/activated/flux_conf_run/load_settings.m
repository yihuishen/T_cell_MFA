...
vbset = true;
vbfrombestfit = true;
vbs = {{'EX_glc__D_e.f', 0, 0.0001},...
    {'EX_gln__L_e.f', 0, 0.0001},...
    {'FECOOR_m.f', 0, 0.0001},...
    {'BIOMASS_c.f', 0, 0.0001},...
    {'EX_ala__L_e.f', 0, 0.0001},...
    {'EX_arg__L_e.f', 0, 0.0001},...
    {'EX_asp__L_e.f', 0, 0.0001},...
    {'EX_gly_e.f', 0, 0.0001},...
    {'EX_ile__L_e.f', 0, 0.0001},...
    {'EX_leu__L_e.f', 0, 0.0001},...
    {'EX_lys__L_e.f', 0, 0.0001},...
    {'EX_met__L_e.f', 0, 0.0001},...
    {'EX_phe__L_e.f', 0, 0.0001},...
    {'EX_pro__L_e.f', 0, 0.0001},...
    {'EX_ser__L_e.f', 0, 0.0001},...
    {'EX_thr__L_e.f', 0, 0.0001},...
    {'EX_val__L_e.f', 0, 0.0001}
};
